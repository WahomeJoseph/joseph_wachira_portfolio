    ...
    <div className="flex flex-col w-full min-h-screen bg-bgcolor justify-between items-center p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 items-center justify-center w-full bg-transparent gap-6 p-4 md:p-8">
        <div className="flex flex-col items-center space-y-2 rounded-md shadow-lg border-b-2 border-b-uscgold px-6 py-4 bg-transparent text-txtcolor">
          ...
          <a href="https://github.com/WahomeJoseph/MY-DENTAL_CLINIC.git"><button className="w-full p-6 md:w-44 h-10 bg-uscgold text-bgcolor text-lg md:text-xl rounded-md hover:bg-gpoppy md:p-4 transition duration-300">
            View More
          </button>
          </a>
        </div>
        <div className="flex flex-col items-center space-y-2 rounded-md shadow-lg border-b-2 border-b-uscgold px-6 py-4 bg-transparent text-txtcolor">
          ...
          <a href="https://github.com/WahomeJoseph/booking-assets.git"><button className="w-full p-6 md:w-44 h-10 bg-uscgold p-4 text-bgcolor text-lg md:text-xl rounded-md hover:bg-gpoppy md:p-4 transition duration-300">
            View More
          </button>
          </a>
        </div>
        <div className="flex flex-col items-center space-y-2 rounded-md shadow-lg border-b-2 border-b-uscgold px-6 py-4 bg-transparent text-txtcolor">
          ...
          <a href=""><button className="w-full p-6 md:w-44 h-10 bg-uscgold p-4 text-bgcolor text-lg md:text-xl rounded-md hover:bg-gpoppy md:p-4 transition duration-300">
            View More
          </button>
          </a>
        </div>
        <div className="flex flex-col items-center space-y-2 rounded-md shadow-lg border-b-2 border-b-uscgold px-6 py-4 bg-transparent text-txtcolor">
          ...
          <a href="https://github.com/WahomeJoseph/trade.git"><button className="w-full p-6 md:w-44 h-10 bg-uscgold p-4 text-bgcolor text-lg md:text-xl rounded-md hover:bg-gpoppy md:p-4 transition duration-300">
            View More
          </button>
          </a>
        </div>
