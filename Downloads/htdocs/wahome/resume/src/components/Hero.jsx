    ...
    >
      <div className="flex flex-col items-center justify-center w-full h-full p-4 bg-black bg-opacity-50">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 m-4 md:m-8">
          ...
          <motion.button animate={{ x: 100, scale: 1 }} initial={{scale:0}} hover whileHover={{scale: 1.15}} transition={{type: 'tween', duration: 1}} className="w-44 h-12 text-lg md:text-xl font-semibold px-4 py-2 rounded-md shadow-md hover:bg-hgold hover:shadow-lg transition duration-300 bg-gbrown text-bgcolor">
            Resume
          </motion.button>
          </a>
          <Link to="/contact">
