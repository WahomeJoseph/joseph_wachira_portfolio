...
export default function About() {
  return (
    <motion.div className="bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#0f172a] via-[#1e1a78] to-[#0f172a] flex-col w-full min-h-screen p-4 md:p-4 space-y-4"
    initial={{ width: 0 }}
    animate={{ width: '100%' }}
    exit={{ x: window.innerWidth, transition: { duration: 0.2} }}>
      ...
      <div className="flex flex-col md:flex-row w-full px-4 md:px-8 gap-4 items-center justify-center">
        ...
        <div className="flex flex-col px-4 sm:px-2 md:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 p-4 m-2 items-center justify-between">
